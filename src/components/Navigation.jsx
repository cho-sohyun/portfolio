...
export const Navigation = () => {
  return (
    <div className="flex flex-col h-screen w-80 bg-gray-100 shadow-md">
      ...
      <nav className="flex-grow">
        <ul className="list-none flex flex-col items-center mt-12">
          <li className="mb-4">
            <a
              href="#intro"
              className="block text-xs hover:text-gray-800 transition-colors duration-300 no-underline relative"
            >
              HOME
